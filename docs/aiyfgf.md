...
- 参数全量说明：
  ...
  2. 提取规则：【必填】固定取值，支持中文、英文、数字与特殊字符，支持变量引用
...
十、AI生成代码强制自检清单
======================
生成枫叶指令宏代码(输出为代码块)后，必须逐条校验以下规则，全部符合才可输出，否则会触发语法错误/执行失效
(代码块格式要求：使用```包裹代码内容，无语言标识也可，确保代码行无缩进、关键字小写、分隔符正确)
