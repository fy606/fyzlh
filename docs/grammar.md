...
---
### **读行**
- 指令格式：表格\读行, 数据名,工作表,位置,读行结果1丨读行结果2丨读行结果3\
- 指令功能：读行内容
- 参数全量说明：
  1. 读行  功能.
  2. 目录
  3. 数据名-要读取那个数据就填哪个
  4. 工作表-默认第一个表就行.
  5. 位置-格式有两种 A1 或 1 1 (空格隔开)当前位置往右读
  6. 读行结果-用丨分隔.读几个写几个
- 合法示例：
```
...
---
### **读列**
- 指令格式：表格\读列, 数据名,工作表,位置,读列结果1丨读列结果2丨读列结果3\
- 指令功能：读列内容
- 参数全量说明：
  1. 读列  功能.
  2. 目录
  3. 数据名-要读取那个数据就填哪个
  4. 工作表-默认第一个表就行.
  5. 位置-格式有两种 A1 或 1 1 (空格隔开)当前位置往下读
  6. 读列结果-用丨分隔.读几个写几个
- 合法示例：
```
表格\读列, 表格数据, 1, 1 2, 列1|列2|列3\
```
---
### **写行**
- 指令格式：表格\写行, 数据名,工作表,位置,写入内容1丨写入内容2丨写入内容3\
- 指令功能：写入一行
- 参数全量说明：
  1. 写行  功能.
  2. 目录
  3. 数据名-要读取那个数据就填哪个
  4. 工作表-默认第一个表就行.
  5. 位置-格式有两种 A1 或 1 1 (空格隔开)当前位置往右
  6. 写入内容-用丨分隔.
- 合法示例：
```
...
---
### **写列**
- 指令格式：表格\写列, 数据名,工作表,位置,写入内容1丨写入内容2丨写入内容3\
- 指令功能：写入一行
- 参数全量说明：
  1. 写列  功能.
  2. 目录
  3. 数据名-要读取那个数据就填哪个
  4. 工作表-默认第一个表就行.
  5. 位置-格式有两种 A1 或 1 1 (空格隔开)当前位置往下
  6. 写入内容-用丨分隔.
- 合法示例：
```
表格\写列, 表格数据, 1, 1 1, 列结果1|列结果2|列结果3\
```
---
### **读公式**
- 指令格式：表格\读公式, 数据名,工作表,位置,公式结果\
- 指令功能：读单格公式
- 参数全量说明：
  1. 读公式  功能.
  2. 目录
...
---
### **写公式**
- 指令格式：表格\写公式, 数据名,工作表,位置,写入公式的字符\
- 指令功能：写入单格公式
- 参数全量说明：
  1. 写公式  功能.
  2. 目录
